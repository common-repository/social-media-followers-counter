...
Followers counter plugin with option to add custom text. It display likes & followers from facebook, twitter, google+, youtube & dribbble.
...
- Google+ username is used rather than userid (instruction added in widget). 
